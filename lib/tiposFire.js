/** Datos que Firebase proporciona sobre un usuario autorizado.
 * @typedef {Object} User
...
/** Implementación de seguridad; por ejemplo Google, Microsoft, Twiter, etc.
 * @see https://firebase.google.com/docs/reference/js/firebase.auth.AuthProvider
 * @typedef {Object} AuthProvider
*/

/** Implementación de AuthProvider que usa el sistema de seguridad de Google,
 * @see https://firebase.google.com/docs/reference/js/firebase.auth.GoogleAuthProvider
 * @typedef {Object} GoogleAuthProvider
 * @property {(p:Object)=>AuthProvider} setCustomParameters asigna parámetros para el sistema OAuth de Google.
 */
